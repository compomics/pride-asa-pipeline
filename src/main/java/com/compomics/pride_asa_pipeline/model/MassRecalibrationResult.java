...
public class MassRecalibrationResult {
     ...
     * @return the Double value for the recorded error at the given charge. Note that
     *         this can be null if there is no mass error for the given charge!
     */
     ...
     * @return the Double value for the recorded error window at the given charge.
     *         Note that this can be null if there is no mass error for the given
     *         charge!
     */
