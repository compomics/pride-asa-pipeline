...
public class AminoAcidSequence {
    ...
    private final List<AminoAcid> aaSequence; //unmodifiable
    private final List<AminoAcid> unknownMassAAs; //unmodifiable
    private final String sequenceString;
    private double sequenceMass;
    private boolean allMassesKnown = true;

    /**
     * Creates an AminoAcidSequence from the provided String.
     * Note: the internally kept List<AminoAcid> is unmodifiable, therefore
     *       once created the sequence can not be modified.
     *
    ...
    /**
     * Creates an AminoAcidSequence from the provided List of AminoAcids.
     * Note: the internally kept List<AminoAcid> is unmodifiable, therefore
     *       once created the sequence can not be modified.
     *
     * @param aaSequence the list of AminoAcids to generate
     *                   the AminoAcidSequence from.
     * @see AminoAcid
     */
     ...
     * @throws IndexOutOfBoundsException if the specified location is
     *                                   outside the sequence. E.g. the index is out of range
    ...
    /**
     * Gets the accumulated mass of the
     *         sequence part for which the mass is known.
     * 
