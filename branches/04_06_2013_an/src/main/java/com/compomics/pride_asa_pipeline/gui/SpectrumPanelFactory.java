...
public class SpectrumPanelFactory {
    ...
    private SpectrumService prideXmlSpectrumService;
    ...
    public SpectrumService getPrideXmlSpectrumService() {
        return prideXmlSpectrumService;
    }

    public void setPrideXmlSpectrumService(SpectrumService prideXmlSpectrumService) {
        this.prideXmlSpectrumService = prideXmlSpectrumService;
    }
