 ...
 */
public class FileResultHandlerImpl3 implements FileResultHandler {

    private static final Logger LOGGER = Logger.getLogger(FileResultHandlerImpl3.class);
    ...
    private void loadModifications() {
        ...
        for (Modification modification : PRIDEModificationFactory.getAsapMods()) {
