...
/**
 * Created by IntelliJ IDEA. User: niels Date: 9/11/11 Time: 17:16 To change
...
public abstract class PrideSpectrumAnnotatorTemplate {
     ...
     * @throws SQLException
     */
    public abstract List<Identification> findBestMatches(String experimentAccession, Map<Identification, Set<ModifiedPeptide>> modifiedPrecursorVariationsMap) throws SQLException;
     ...
     * @param modifiedPeptidesMap the modified precursors map (keys: the
     * identification data, values: the modified peptides)
     * @throws SQLException
     */
    ...
    /**
     * processes the results of the spectra matching without taking into account
     * any modifications
     *
